# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-14 06:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, help_text='The user of this phone line', null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.Client')),
            ],
        ),
        migrations.CreateModel(
            name='Package',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.SelectedNumbers'),
        ),
        migrations.AddField(
            model_name='line',
            name='package',
        ...
        migrations.AddField(
            model_name='client',
            name='type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='clients', to='crm.ClientType'),
        ),
        migrations.AddField(
            model_name='call',
            name='line',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.Line'),
        ),
    ]
